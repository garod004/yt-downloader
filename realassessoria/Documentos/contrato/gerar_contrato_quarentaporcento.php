...
<body>
    ...
    <div class="info-row">
        ...
        Portador do documento de identidade Nº: $rg_cliente, portador(a) do CPF nº $cpf_cliente, residente e domiciliado(a) na
        $endereco_cliente, $cidade_cliente - $uf_cliente, telefone para contato $telefone_cliente, e-mail: $email_cliente.
    ...
    <div class="content-box">
        Real Assessoria Previdenciária, CNPJ: 13.244.474/0001-20, Rua M, Nº 65, Nova Cidade, 
        CEP:69.097-030, Manaus - AM, neste ato representada por Dioleno Nóbrega Silva, (92)99129-
    ...
    <div class="content-box">
        ...
        <p>CLÁUSULA 1ª – O presente instrumento tem como objetivo a prestação de serviços de assessoria a serem realizados pelo Contratado, na representação e defesa dos interesses do(a) Contratante, sendo realizado na via administrativa ou judicial, em qualquer juízo e/ou instância, apresentar e opor ações, bem como de interpor os recursos necessários e competentes para garantir a proteção e o exercício dos seus direitos.</p>
        <p>CLÁUSULA 2ª – O Contratante assume a obrigatoriedade de efetuar o pagamento pelos serviços prestados ao Contratado no valor de <strong>40% (Quarenta por cento) do benefício</strong> no ato da implantação do benefício. Caso não haja cumprimento no acordo de pagamento, a contratante pagará a título de juros um percentual de 3% sobre cada parcela!</p>
        <p>CLÁUSULA 3ª – Deixando o Contratante de imotivadamente ter o patrocínio destes causídicos, ora Contratado, não a desobriga ao pagamento dos honorários ajustados integralmente.</p>
        Parágrafo Único – Em caso de desistência ou qualquer ato de desídia do Contratante como deixar de comparecer em qualquer ato do processo que gera a extinção ou a improcedência da ação ou de alguns dos pedidos da demanda, será aplicada uma multa de R$ 2.000,00 (dois mil reais).</p>
        <p>CLÁUSULA 4ª – Caso haja morte ou incapacidade civil em ocorrência do contratado, a contratada constituida receberá os honorários na proporção do trabalho realizado.</p>
        <p>CLÁUSULA 5ª – As partes elegem o foro da Comarca de Manaus – AM.</p>
        <p>CLÁUSULA 6ª – Por estarem assim justos e contratados, firmam o presente CONTRATO DE HONORÁRIOS POR SERVIÇOS PRESTADOS em duas vias de igual teor e forma, para que o mesmo, nos seus devidos fins de direito, produza seus jurídicos e legais efeitos, juntamente com as 02 (duas) testemunhas, igualmente subscritas, identificadas e assinadas.</p>
    </div>
...
// 5. Enviar o PDF para o navegador (Attachment = 1 força download)
$nome_arquivo = "Contrato_Servicos_" . str_replace(' ', '_', $nome_cliente) . ".pdf";
