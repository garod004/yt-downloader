...
// 4. Buscar dados do cadastro A ROGO
...
if ($stmt_rogo = $conn->prepare($sql_a_rogo)) {
    ...
    $stmt_rogo->execute();
    $a_rogo = stmt_fetch_first_assoc_contrato_justica($stmt_rogo);
    $stmt_rogo->close();
}
...
<body>
    ...
    <div class="assinaturas">
        ...
        <div class="linha-assinatura"></div>
        <div class="assinatura-texto"><span class="assinatura-texto-observacao">Assinatura de quem firma a rogo, a pedido do(a) Contratante</span><strong>$a_rogo_nome</strong><br>CPF: $a_rogo_cpf</div>
