<?php
require_once dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . basename(__FILE__);
return;
?>
...
<body>
    ...
    <!-- Declaração -->
    <div class="content-box">
        <p>Venho por meio desta declarar que não possuo comprovante de residência em meu nome, declaro ainda, que estou ciente 
        de que declaração falsa pode implicar na sansão penal prevista no art.299 do código penal, in verbis. Art. 299 - Omitir, 
        em documento público ou particular, declaração que dele devia constar, ou nele inserir ou fazer inserir declaração falsa 
        ou diversa da que devia ser escrita, com o fim de prejudicar direito, criar obrigação ou alterar a verdade sobre fato 
        ...
        alteração é de assentamento de registro civil, aumenta-se a pena de sexta parte.</p>
    </div>
...
$nome_arquivo = "Declaracao_Residencia_" . str_replace(' ', '_', $nome_cliente) . ".pdf";
